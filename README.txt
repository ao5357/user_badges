...
Once the module and sql files are installed and activated, select 'user badges' 
from the 'settings' section of 'administer'. Here you'll find three tabbed
sections for User Badges. 'edit user badges' allows you to add and edit badges.
